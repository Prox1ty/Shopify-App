            ...
            <div className="w-full max-w-4xl">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-6 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end">
                        ...
                        <button className="py-4 px-8 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 active:scale-[0.98] text-white text-lg font-semibold rounded-xl transition-all duration-200 shadow-sm cursor-pointer">
                            Checkout
                        </button>
                    </div>
                </div>
